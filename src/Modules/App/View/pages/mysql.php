...
-- После запуска приложения к бд можно подключиться
-- jdbc:mariadb://localhost:3306/explorer
-- доступы в файле .env

---------------------------------------------------

-- "ДАМП" структуры таблиц,
-- настоящий дамп можно посмотреть в /docker/mariadb/dump/db.sql
...
INSERT INTO motorcycle_types (name) VALUES ('Sport');
